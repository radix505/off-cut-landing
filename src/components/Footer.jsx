    ...
    <footer className="footer-pro">
      ...
      <div className="footer-pro-bottom">
        ...
        <div className="footer-credit">
          {useT('Stworzone przez', 'Created by')} <img src="https://corelaners.eu/logo-white.svg" alt="Corelaners" className="footer-credit-logo" /><a href="https://corelaners.eu" target="_blank" rel="noopener noreferrer">corelaners.eu</a>
        </div>
      </div>
    </footer>
  );

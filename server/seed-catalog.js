...
const SERVICES = [
  { num: '001', namePL: 'Strzyżenie Męskie Włosy Krótkie', nameEN: "Men's Cut — Short Hair",
    ...
    duration: '50 min', durationMin: 50, pricePLN: 100, delay: 1, barbers: ['OLEK', 'JULIA'] },
  { num: '002', namePL: 'Strzyżenie Męskie Włosy Długie', nameEN: "Men's Cut — Long Hair",
    ...
    duration: '1h', durationMin: 60, pricePLN: 110, delay: 2, barbers: ['OLEK', 'JULIA'] },
  { num: '003', namePL: 'Trymowanie Brody', nameEN: 'Beard Trim',
    ...
    duration: '20 min', durationMin: 20, pricePLN: 80, delay: 3, barbers: ['OLEK', 'JULIA'] },
  { num: '004', namePL: 'Strzyżenie Głowy i Brody', nameEN: 'Cut & Beard',
    ...
    duration: '1h 10min', durationMin: 70, pricePLN: 140, delay: 1, barbers: ['OLEK', 'JULIA'] },
  { num: '005', namePL: 'Golenie Głowy Maszynką', nameEN: 'Head Shave — One Length',
    ...
    duration: '10 min', durationMin: 10, pricePLN: 50, delay: 2, barbers: ['OLEK', 'JULIA'] },
  { num: '006', namePL: 'Golenie Głowy Maszynką + Broda', nameEN: 'Head Shave + Beard',
    ...
    duration: '30 min', durationMin: 30, pricePLN: 100, delay: 3, barbers: ['OLEK', 'JULIA'] },
  { num: '007', namePL: 'Strzyżenie Głowy i Brody + Brzytwa', nameEN: 'Cut & Beard + Straight Razor',
    ...
    duration: '1h 15min', durationMin: 75, pricePLN: 170, delay: 2, barbers: ['OLEK', 'JULIA'] },
  { num: '008', namePL: 'Strzyżenie Męskie Włosy Krótkie', nameEN: "Men's Cut — Short Hair",
    descPL: 'Precyzyjne strzyżenie krótkich włosów. Czyste linie, dopasowane do kształtu głowy.',
    descEN: 'Precise short hair cut. Clean lines, shaped to your head.',
    duration: '1h', durationMin: 60, pricePLN: 80, delay: 3, barbers: ['NICO'] },
  { num: '009', namePL: 'Strzyżenie Męskie Włosy Długie', nameEN: "Men's Cut — Long Hair",
    descPL: 'Strzyżenie długich włosów z dbałością o teksturę i ruch.',
    descEN: 'Long hair cut with attention to texture and movement.',
    duration: '1h 20min', durationMin: 80, pricePLN: 90, delay: 1, barbers: ['NICO'] },
  { num: '010', namePL: 'Trymowanie Brody', nameEN: 'Beard Trim',
    descPL: 'Kształt, krawędzie, definicja. Broda pod kontrolą.',
    descEN: 'Shape, edge, define. Beard back in line.',
    duration: '40 min', durationMin: 40, pricePLN: 60, delay: 2, barbers: ['NICO'] },
  { num: '011', namePL: 'Strzyżenie Głowy i Brody', nameEN: 'Cut & Beard',
    descPL: 'Kompletna wizyta. Włosy i broda w jednym czasie, przez jednego rzemieślnika.',
    descEN: 'Full visit. Hair and beard in one sitting, by one craftsman.',
    duration: '1h 30min', durationMin: 90, pricePLN: 130, delay: 3, barbers: ['NICO'] },
  { num: '012', namePL: 'Golenie Głowy Maszynką', nameEN: 'Head Shave — One Length',
    descPL: 'Gładkie golenie maszynką na jedną długość. Szybko, czysto, równo.',
    descEN: 'Clean machine shave at one length. Fast, precise, even.',
    duration: '30 min', durationMin: 30, pricePLN: 40, delay: 1, barbers: ['NICO'] },
  { num: '013', namePL: 'Golenie Głowy Maszynką + Broda', nameEN: 'Head Shave + Beard',
    descPL: 'Golenie głowy maszynką z pełnym trymowaniem brody.',
    descEN: 'Machine head shave with full beard trim.',
    duration: '1h', durationMin: 60, pricePLN: 100, delay: 2, barbers: ['NICO'] },
];
...
const insertService = db.prepare(`
  INSERT INTO services
    (id, name_pl, name_en, desc_pl, desc_en, duration_min, duration_label, price_pln, delay, sort_order)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
...
export function seedCatalogIfEmpty(logger) {
  ...
  const tx = db.transaction(() => {
    ...
    for (const [i, s] of SERVICES.entries()) {
      insertService.run(s.num, s.namePL, s.nameEN, s.descPL, s.descEN, s.durationMin, s.duration, s.pricePLN, s.delay, i);

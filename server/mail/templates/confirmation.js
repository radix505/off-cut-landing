...
const T = {
  pl: {
    ...
    received: {
      ...
      headline: 'Zanotowane.',
      intro: (name) => `${name}, mamy Twoje zgłoszenie. Barber zatwierdzi termin w ciągu kilku minut. Wtedy dostaniesz drugą wiadomość z pełnym potwierdzeniem.`,
      infoCardTitle: 'CO DALEJ',
      infoCardBody: 'Czekamy aż barber zatwierdzi termin. Mail z pełnym potwierdzeniem przyjdzie zaraz po tym.',
  ...
  en: {
    ...
    received: {
      subjectStatus: 'Appointment saved',
      eyebrow: 'REQUEST RECEIVED',
      sectionNumber: '00',
      slotEyebrow: 'AWAITING CONFIRMATION',
      headline: 'Noted.',
      intro: (name) => `${name}, we have your request. The barber will confirm the slot within a few minutes. You will then get a second email with the full confirmation.`,
      infoCardTitle: 'WHAT NEXT',
      infoCardBody: 'We are waiting for the barber to confirm. An email with the full confirmation follows right after.',
      needToChangeTitle: 'Mistake?',
      needToChangeBody: 'Call us if you need to change anything before the slot is confirmed.',
      showOnArrival: 'We are holding the slot for you. After confirmation you will get a second email.',
    ...
    confirmed: {
      ...
      intro: (name) => `${name}, your appointment has been confirmed. Date and details below.`,
      infoCardTitle: 'ADD TO CALENDAR',
      infoCardBody: 'The .ics file is attached; open it on your phone or in your calendar.',
      needToChangeTitle: 'Something changed?',
      needToChangeBody: 'Call us directly.',
      showOnArrival: 'We recommend arriving 5 minutes early.',
      footerLegal: 'You are receiving this because your booking at Off Cut has been confirmed.',
    },
    rescheduled: {
      subjectStatus: 'Appointment rescheduled',
      eyebrow: 'APPOINTMENT RESCHEDULED',
      sectionNumber: '02',
      slotEyebrow: null,
      headline: 'New date.',
      intro: (name) => `${name}, your appointment has been moved to a new time. Full details below.`,
      infoCardTitle: 'UPDATE YOUR CALENDAR',
      infoCardBody: 'The attached .ics file will update the existing entry in your calendar to the new time - just open it.',
      needToChangeTitle: 'Something changed?',
      needToChangeBody: 'Call us directly.',
      showOnArrival: 'We recommend arriving 5 minutes early.',
    ...
    cancelled: {
      subjectStatus: 'Appointment cancelled',
      eyebrow: 'APPOINTMENT CANCELLED',
      sectionNumber: '03',
      slotEyebrow: 'SLOT RELEASED',
      headline: 'Until next time.',
      intro: (name) => `${name}, your appointment has been cancelled. The slot is now released. If you would like to book again - call us or reserve online.`,
      infoCardTitle: 'WANT TO BOOK AGAIN?',
      infoCardBody: 'Reserve a new slot at off-cut.pl or call us. The attached .ics file removes the cancelled appointment from your calendar.',
      needToChangeTitle: 'Mistake?',
      needToChangeBody: 'If the cancellation was a mistake, call right away - if possible we will restore the same slot.',
      showOnArrival: 'We will see you next time.',
